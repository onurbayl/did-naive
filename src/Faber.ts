...
export class Faber extends BaseAgent {
  ...
  public static async build(): Promise<Faber> {
    const faber = new Faber(9001, 'Securify')
  ...
  private async waitForConnection() {
    ...
    //console.log('An Holder agent is being waited to accept the invitation...')
    ...
    try {
      ...
      console.log(redText(`\nTimeout of 200 seconds reached.. Returning to home screen.\n`))
      return
    }
  ...
  private printSchema(name: string, version: string, attributes: string[]) {
    ...
    console.log(purpleText(`Attributes: ${Color.Reset}${attributes[0]}, ${attributes[1]}, ${attributes[2]}, ${attributes[3]}, ${attributes[4]}\n`))
  }
  ...
  private async registerSchema() {
    ...
    const schemaTemplate = {
      name: 'Securify Employee-' + utils.uuid(),
      version: '1.0.0',
      attrNames: ['name', 'position', 'degree', 'dob', 'salary'],
  ...
  public async issueCredential() {
    ...
    this.ui.updateBottomBar(
      `\nCredential Offer is sent to Holder agent\n\n${Color.Reset}`
    )
  }
  ...
  public async sendProofRequest() {
    ...
    this.ui.updateBottomBar(
      `\nProof request is sent to Holder agent\n\n${Color.Reset}`
    )
  }
